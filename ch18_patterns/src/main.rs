fn main() {
    ...
    match x {
        ...
        Some(y) => println!("Matched, y = {:?}", y), // note y shadows
    ...
    // println!("{:?}", s); // s has been moved to _s
    ...
    match robot_name {
        // Legacy rust required &Some to match &Some,
        // then ref name to require name to be a reference
